...
<head>
    ...
    <title>【Laravel】使用QQ SMTP发送邮件 - 碎念</title>
...
.env&nbsp; 在根目录下面，composer初始化项目的时候会生成/config/mail.php
...
<meta name='description' content='1、 Laravel 文件 需要涉及到的文件 .env&nbsp; 在根目录下面，composer初始化项目的时候会生成/config/mail.php 2、 .env代码 [crayon-5cde2276803bd537526126/] 3、mail.php 代码 其中要设置一下发件人以及名字\'from\' =&gt; [\'addres ...' />
...
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-230"><a href="https://zhaoshuai.me/job-position/">Job Position</a></li>
    ...
    <article class="mod-post mod-post__type-post">
        <header>
            <h1 class="mod-post__title">【Laravel】使用QQ SMTP发送邮件</h1>
        </header>
...
<!-- Crayon Syntax Highlighter v_2.7.2_beta -->
		...
		<div id="crayon-5cde2276803bd537526126" class="crayon-syntax crayon-theme-solarized-light crayon-font-monaco crayon-os-mac print-yes notranslate" data-settings=" minimize scroll-mouseover" style=" margin-top: 12px; margin-bottom: 12px; font-size: 12px !important; line-height: 15px !important;">
...
MAIL_ENCRYPTION=ssl</textarea></div>
			<div class="crayon-main" style="">
				<table class="crayon-table">
					<tr class="crayon-row">
				<td class="crayon-nums " data-settings="show">
					<div class="crayon-nums-content" style="font-size: 12px !important; line-height: 15px !important;"><div class="crayon-num" data-line="crayon-5cde2276803bd537526126-1">1</div><div class="crayon-num crayon-striped-num" data-line="crayon-5cde2276803bd537526126-2">2</div><div class="crayon-num" data-line="crayon-5cde2276803bd537526126-3">3</div><div class="crayon-num crayon-striped-num" data-line="crayon-5cde2276803bd537526126-4">4</div><div class="crayon-num" data-line="crayon-5cde2276803bd537526126-5">5</div><div class="crayon-num crayon-striped-num" data-line="crayon-5cde2276803bd537526126-6">6</div></div>
				</td>
						<td class="crayon-code"><div class="crayon-pre" style="font-size: 12px !important; line-height: 15px !important; -moz-tab-size:4; -o-tab-size:4; -webkit-tab-size:4; tab-size:4;"><div class="crayon-line" id="crayon-5cde2276803bd537526126-1"><span class="crayon-v">MAIL_DRIVER</span><span class="crayon-o">=</span><span class="crayon-e">smtp</span></div><div class="crayon-line crayon-striped-line" id="crayon-5cde2276803bd537526126-2"><span class="crayon-v">MAIL_HOST</span><span class="crayon-o">=</span><span class="crayon-v">smtp</span><span class="crayon-sy">.</span><span class="crayon-v">qq</span><span class="crayon-sy">.</span><span class="crayon-e">com</span></div><div class="crayon-line" id="crayon-5cde2276803bd537526126-3"><span class="crayon-v">MAIL_PORT</span><span class="crayon-o">=</span><span class="crayon-cn">465</span></div><div class="crayon-line crayon-striped-line" id="crayon-5cde2276803bd537526126-4"><span class="crayon-v">MAIL_USERNAME</span><span class="crayon-o">=</span><span class="crayon-sy">[</span><span class="crayon-o">*</span><span class="crayon-o">*</span>邮箱地址<span class="crayon-o">*</span><span class="crayon-o">*</span><span class="crayon-sy">]</span></div><div class="crayon-line" id="crayon-5cde2276803bd537526126-5"><span class="crayon-v">MAIL_PASSWORD</span><span class="crayon-o">=</span><span class="crayon-sy">[</span><span class="crayon-o">*</span><span class="crayon-o">*</span><span class="crayon-i">QQ</span>邮箱的授权码（不是邮箱密码）<span class="crayon-o">*</span><span class="crayon-o">*</span><span class="crayon-sy">]</span></div><div class="crayon-line crayon-striped-line" id="crayon-5cde2276803bd537526126-6"><span class="crayon-v">MAIL_ENCRYPTION</span><span class="crayon-o">=</span><span class="crayon-v">ssl</span></div></div></td>
					</tr>
				</table>
			</div>
		</div>
...
<!-- Crayon Syntax Highlighter v_2.7.2_beta -->
		...
		<div id="crayon-5cde2276803c7736070341" class="crayon-syntax crayon-theme-solarized-light crayon-font-monaco crayon-os-mac print-yes notranslate" data-settings=" minimize scroll-mouseover" style=" margin-top: 12px; margin-bottom: 12px; font-size: 12px !important; line-height: 15px !important;">
    ...
    $message-&gt;to($to)-&gt;subject('12306抢票邮件, 有票啦~~');
			...
			<div class="crayon-main" style="">
				<table class="crayon-table">
					<tr class="crayon-row">
				<td class="crayon-nums " data-settings="show">
					<div class="crayon-nums-content" style="font-size: 12px !important; line-height: 15px !important;"><div class="crayon-num" data-line="crayon-5cde2276803c7736070341-1">1</div><div class="crayon-num crayon-striped-num" data-line="crayon-5cde2276803c7736070341-2">2</div><div class="crayon-num" data-line="crayon-5cde2276803c7736070341-3">3</div><div class="crayon-num crayon-striped-num" data-line="crayon-5cde2276803c7736070341-4">4</div></div>
				</td>
						<td class="crayon-code"><div class="crayon-pre" style="font-size: 12px !important; line-height: 15px !important; -moz-tab-size:4; -o-tab-size:4; -webkit-tab-size:4; tab-size:4;"><div class="crayon-line" id="crayon-5cde2276803c7736070341-1"><span class="crayon-v">Mail</span><span class="crayon-o">::</span><span class="crayon-e">send</span><span class="crayon-sy">(</span><span class="crayon-s">'email'</span><span class="crayon-sy">,</span><span class="crayon-h"> </span><span class="crayon-sy">[</span><span class="crayon-s">'data'</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-o">&gt;</span><span class="crayon-h"> </span><span class="crayon-sy">$</span><span class="crayon-v">data</span><span class="crayon-sy">]</span><span class="crayon-sy">,</span><span class="crayon-h"> </span><span class="crayon-t">function</span><span class="crayon-h"> </span><span class="crayon-sy">(</span><span class="crayon-sy">$</span><span class="crayon-v">message</span><span class="crayon-sy">)</span><span class="crayon-h"> </span><span class="crayon-sy">{</span></div><div class="crayon-line crayon-striped-line" id="crayon-5cde2276803c7736070341-2"><span class="crayon-h">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="crayon-sy">$</span><span class="crayon-st">to</span><span class="crayon-h"> </span><span class="crayon-o">=</span><span class="crayon-h"> </span><span class="crayon-s">'982599220@qq.com'</span><span class="crayon-sy">;</span></div><div class="crayon-line" id="crayon-5cde2276803c7736070341-3"><span class="crayon-h">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="crayon-sy">$</span><span class="crayon-v">message</span><span class="crayon-o">-&gt;</span><span class="crayon-st">to</span><span class="crayon-sy">(</span><span class="crayon-sy">$</span><span class="crayon-st">to</span><span class="crayon-sy">)</span><span class="crayon-o">-&gt;</span><span class="crayon-e">subject</span><span class="crayon-sy">(</span><span class="crayon-s">'12306抢票邮件, 有票啦~~'</span><span class="crayon-sy">)</span><span class="crayon-sy">;</span></div><div class="crayon-line crayon-striped-line" id="crayon-5cde2276803c7736070341-4"><span class="crayon-sy">}</span><span class="crayon-sy">)</span><span class="crayon-sy">;</span></div></div></td>
					</tr>
				</table>
			</div>
		</div>
...
<p></p>
        ...
        <div class="mod-post__meta">
            <div>
                <div>— 于
                    <time datetime="2018年09月21日 12:15:42">2018年09月21日</time>
                    ，<span>共写了335个字</span>；
                </div>
                <div>— 文内使用到的标签：<span class="mod_tag"><a href="https://zhaoshuai.me/tag/php/" rel="tag">PHP</a></span></div>
            </div>
        </div>
        <ul class="sxwk">
            <li></li>
...
<!-- You can start editing here. -->
	...
	<ol class="commentlist">
			<li class="comment byuser comment-author-zhaoshuai bypostauthor even thread-even depth-1" id="comment-2">
				<div id="div-comment-2" class="comment-body">
				<div class="comment-author vcard">
			<img alt='' src='https://secure.gravatar.com/avatar/256c88fc2de20125bfaf6a16c3c9f6f3?s=32&#038;d=mm&#038;r=g' srcset='https://secure.gravatar.com/avatar/256c88fc2de20125bfaf6a16c3c9f6f3?s=64&#038;d=mm&#038;r=g 2x' class='avatar avatar-32 photo' height='32' width='32' />			<cite class="fn">zhaoshuai</cite><span class="says">说道：</span>		</div>
		
		<div class="comment-meta commentmetadata"><a href="https://zhaoshuai.me/2018-09-21/#comment-2">
			2018年9月21日 下午2:03				</a>
				&nbsp;&nbsp;<a class="comment-edit-link" href="https://zhaoshuai.me/wp-admin/comment.php?action=editcomment&#038;c=2">(编辑)</a>		</div>

		<p>你好呀</p>

		<div class="reply"><a rel='nofollow' class='comment-reply-link' href='/2018-09-21/?replytocom=2#respond' data-commentid="2" data-postid="16" data-belowelement="div-comment-2" data-respondelement="respond" aria-label='回复给zhaoshuai'>回复</a></div>
				</div>
				</li><!-- #comment-## -->
	</ol>
	...
	<div id="respond" class="comment-respond">
		<h3 id="reply-title" class="comment-reply-title">发表评论 <small><a rel="nofollow" id="cancel-comment-reply-link" href="/2018-09-21/#respond" style="display:none;">取消回复</a></small></h3>			<form action="https://zhaoshuai.me/wp-comments-post.php" method="post" id="commentform" class="comment-form">
				<p class="logged-in-as"><a href="https://zhaoshuai.me/wp-admin/profile.php" aria-label="已登入为zhaoshuai。编辑您的个人资料。">已登入为zhaoshuai</a>。<a href="https://zhaoshuai.me/wp-login.php?action=logout&amp;redirect_to=https%3A%2F%2Fzhaoshuai.me%2F2018-09-21%2F&amp;_wpnonce=71dfd39768">登出？</a></p><p class="comment-form-comment"><label for="comment">评论</label> <textarea id="comment" name="comment" cols="45" rows="8" maxlength="65525" required="required"></textarea></p><p class="form-submit"><input name="submit" type="submit" id="submit" class="submit" value="发表评论" /> <input type='hidden' name='comment_post_ID' value='16' id='comment_post_ID' />
<input type='hidden' name='comment_parent' id='comment_parent' value='0' />
</p><p style="display: none;"><input type="hidden" id="akismet_comment_nonce" name="akismet_comment_nonce" value="686c90b6d2" /></p><input type="hidden" id="_wp_unfiltered_html_comment_disabled" name="_wp_unfiltered_html_comment_disabled" value="9fc6cce060" /><script>(function(){if(window===window.parent){document.getElementById('_wp_unfiltered_html_comment_disabled').name='_wp_unfiltered_html_comment';}})();</script>
