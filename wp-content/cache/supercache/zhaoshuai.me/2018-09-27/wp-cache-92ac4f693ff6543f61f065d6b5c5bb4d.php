...
<head>
    ...
    <title>【Mac】APP无法打开或文件损坏的处理方法 - 碎念</title>
...
有些用户下载了一些程序之后，却发现无法在MAC中安装，安装时会弹出下图所示警告框：“打不开 xxx，因为它来自身份不明的开发者”；xxx.app已损坏，打不开。你应该将它移到废纸篓
...
<meta name='description' content='1、遇到问题 有些用户下载了一些程序之后，却发现无法在MAC中安装，安装时会弹出下图所示警告框：“打不开 xxx，因为它来自身份不明的开发者”；xxx.app已损坏，打不开。你应该将它移到废纸篓 2、原因 在&nbsp;MAC 下安装一些软件时提示\"来自身份 ...' />
...
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-230"><a href="https://zhaoshuai.me/job-position/">Job Position</a></li>
    ...
    <article class="mod-post mod-post__type-post">
        <header>
            <h1 class="mod-post__title">【Mac】APP无法打开或文件损坏的处理方法</h1>
        </header>
...
<!-- Crayon Syntax Highlighter v_2.7.2_beta -->
		...
		<div id="crayon-5cdd8053598e5399389522" class="crayon-syntax crayon-theme-solarized-light crayon-font-monaco crayon-os-mac print-yes notranslate" data-settings=" minimize scroll-mouseover" style=" margin-top: 12px; margin-bottom: 12px; font-size: 12px !important; line-height: 15px !important;">
...
sudo spctl --master-disable</textarea></div>
			<div class="crayon-main" style="">
				<table class="crayon-table">
					<tr class="crayon-row">
				<td class="crayon-nums " data-settings="show">
					<div class="crayon-nums-content" style="font-size: 12px !important; line-height: 15px !important;"><div class="crayon-num" data-line="crayon-5cdd8053598e5399389522-1">1</div></div>
				</td>
						<td class="crayon-code"><div class="crayon-pre" style="font-size: 12px !important; line-height: 15px !important; -moz-tab-size:4; -o-tab-size:4; -webkit-tab-size:4; tab-size:4;"><div class="crayon-line" id="crayon-5cdd8053598e5399389522-1"><span class="crayon-e">sudo </span><span class="crayon-v">spctl</span><span class="crayon-h"> </span><span class="crayon-o">--</span><span class="crayon-v">master</span><span class="crayon-o">-</span><span class="crayon-v">disable</span></div></div></td>
					</tr>
				</table>
			</div>
		</div>
...
<h4>macOS Sierra 10.12 之后的系统可能没有 “任何来源” 这个选项，打开<code>终端（命令行）</code>，输入一下命令，然后按<code>回车</code>。然后会看见个<code>password</code>，继续输入自己电脑解锁密码，重新打开安全与隐私，就看见任何来源了。</h4>
        ...
        <div class="mod-post__meta">
            <div>
                <div>— 于
                    <time datetime="2018年09月27日 10:23:36">2018年09月27日</time>
                    ，<span>共写了422个字</span>；
                </div>
        ...
        <ul class="sxwk">
            <li></li>
            <li>上一篇：<a href="https://zhaoshuai.me/2019-05-05/" rel="next">【Mac】优雅的使用mail软件</a></li>
        </ul>
    </article>
...
<!-- You can start editing here. -->
	...
	<ol class="commentlist">
			...
			<img alt='' src='https://secure.gravatar.com/avatar/54149a2f1d086ad189e51d898de749d7?s=32&#038;d=mm&#038;r=g' srcset='https://secure.gravatar.com/avatar/54149a2f1d086ad189e51d898de749d7?s=64&#038;d=mm&#038;r=g 2x' class='avatar avatar-32 photo' height='32' width='32' />			<cite class="fn"><a href='http://www.luo.la/' rel='external nofollow' class='url'>罗拉</a></cite><span class="says">说道：</span>		</div>
		
		<div class="comment-meta commentmetadata"><a href="https://zhaoshuai.me/2018-09-27/#comment-3">
			2018年9月29日 下午4:38				</a>
				&nbsp;&nbsp;<a class="comment-edit-link" href="https://zhaoshuai.me/wp-admin/comment.php?action=editcomment&#038;c=3">(编辑)</a>		</div>

		<p>呵呵。学习了。感触良多！</p>

		<div class="reply"><a rel='nofollow' class='comment-reply-link' href='/2018-09-27/?replytocom=3#respond' data-commentid="3" data-postid="56" data-belowelement="div-comment-3" data-respondelement="respond" aria-label='回复给罗拉'>回复</a></div>
				</div>
				<ul class="children">
		<li class="comment byuser comment-author-zhaoshuai bypostauthor odd alt depth-2" id="comment-11">
		...
		<div class="comment-meta commentmetadata"><a href="https://zhaoshuai.me/2018-09-27/#comment-11">
			2018年11月10日 下午3:57				</a>
				&nbsp;&nbsp;<a class="comment-edit-link" href="https://zhaoshuai.me/wp-admin/comment.php?action=editcomment&#038;c=11">(编辑)</a>		</div>

		<p>感谢认可~</p>

		<div class="reply"><a rel='nofollow' class='comment-reply-link' href='/2018-09-27/?replytocom=11#respond' data-commentid="11" data-postid="56" data-belowelement="div-comment-11" data-respondelement="respond" aria-label='回复给zhaoshuai'>回复</a></div>
				</div>
				</li><!-- #comment-## -->
</ul><!-- .children -->
</li><!-- #comment-## -->
	...
	<div id="respond" class="comment-respond">
		<h3 id="reply-title" class="comment-reply-title">发表评论 <small><a rel="nofollow" id="cancel-comment-reply-link" href="/2018-09-27/#respond" style="display:none;">取消回复</a></small></h3>			<form action="https://zhaoshuai.me/wp-comments-post.php" method="post" id="commentform" class="comment-form">
				<p class="logged-in-as"><a href="https://zhaoshuai.me/wp-admin/profile.php" aria-label="已登入为zhaoshuai。编辑您的个人资料。">已登入为zhaoshuai</a>。<a href="https://zhaoshuai.me/wp-login.php?action=logout&amp;redirect_to=https%3A%2F%2Fzhaoshuai.me%2F2018-09-27%2F&amp;_wpnonce=a0766f365c">登出？</a></p><p class="comment-form-comment"><label for="comment">评论</label> <textarea id="comment" name="comment" cols="45" rows="8" maxlength="65525" required="required"></textarea></p><p class="form-submit"><input name="submit" type="submit" id="submit" class="submit" value="发表评论" /> <input type='hidden' name='comment_post_ID' value='56' id='comment_post_ID' />
<input type='hidden' name='comment_parent' id='comment_parent' value='0' />
</p><p style="display: none;"><input type="hidden" id="akismet_comment_nonce" name="akismet_comment_nonce" value="c1206c6512" /></p><input type="hidden" id="_wp_unfiltered_html_comment_disabled" name="_wp_unfiltered_html_comment_disabled" value="9f1e811b4e" /><script>(function(){if(window===window.parent){document.getElementById('_wp_unfiltered_html_comment_disabled').name='_wp_unfiltered_html_comment';}})();</script>
